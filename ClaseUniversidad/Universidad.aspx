<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Universidad.aspx.cs" Inherits="FundaVida.PopUp" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="txtIdUniversidad" runat="server"></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="txtNombreUniversidad" runat="server"></asp:TextBox>
                </div>
            </div>
        </div>
